...
// В задании не указано про исходные данные, какое именно число выводить,
// поэтому решил, что сперва я найду на определенном промежутке искомые числа
// и запишу их в массив, а потом рандомом выведу какой-либо элемент массива.
// Может быть заморочился :) , можно было проще вводить самому числа и проверять,
// но раз задание такое неопределенное :)
